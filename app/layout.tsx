...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/images/logos/addocu/favicon-16x16-removebg-preview.png', sizes: '16x16', type: 'image/png' },
      { url: '/images/logos/addocu/favicon-32x32-removebg-preview.png', sizes: '32x32', type: 'image/png' },
      { url: '/images/logos/addocu/favicon.ico', sizes: 'any' }
    ],
    apple: [
      { url: '/images/logos/addocu/apple-touch-icon-removebg-preview.png', sizes: '180x180', type: 'image/png' }
    ],
    other: [
      { url: '/images/logos/addocu/android-chrome-192x192-removebg-preview.png', sizes: '192x192', type: 'image/png' },
      { url: '/images/logos/addocu/android-chrome-512x512-removebg-preview.png', sizes: '512x512', type: 'image/png' }
    ]
  },
  ...
  return (
    ...
    >
      <head>
        ...
        <link rel="icon" href="/images/logos/addocu/favicon-16x16-removebg-preview.png" sizes="16x16" type="image/png" />
        <link rel="icon" href="/images/logos/addocu/favicon-32x32-removebg-preview.png" sizes="32x32" type="image/png" />
        <link rel="apple-touch-icon" href="/images/logos/addocu/apple-touch-icon-removebg-preview.png" />
